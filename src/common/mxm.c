...
/*  Perform the matrix multiplication */
	...
	for (j = 1; j <= 3; ++j) {
	    prodm[
                  (i__1 = i__ + j * 3 - 4) < 9 && 0 <= i__1
                  ? i__1
                  : s_rnge("prodm", i__1, "mxm_", (ftnlen)162)
                  ]
              = m1[(i__2 = i__ - 1) < 9 && 0 <= i__2
                   ? i__2
                   : s_rnge("m1", i__2, "mxm_", (ftnlen)162)
                   ]
              * m2[(i__3 = j * 3 - 3) < 9 && 0 <= i__3
                   ? i__3
                   : s_rnge("m2", i__3, "mxm_", (ftnlen)162)
                   ]
              + m1[(i__4 = i__ + 2) < 9 && 0 <= i__4
                   ? i__4
                   : s_rnge("m1", i__4, "mxm_", (ftnlen)162)
                   ]
              * m2[(i__5 = j * 3 - 2) < 9 && 0 <= i__5
                   ? i__5
                   : s_rnge("m2", i__5, "mxm_", (ftnlen) 162)
                   ]
              + m1[(i__6 = i__ + 5) < 9 && 0 <= i__6
                   ? i__6
                   : s_rnge("m1", i__6, "mxm_", (ftnlen)162)
                   ]
              * m2[(i__7 = j * 3 - 1) < 9 && 0 <= i__7
                   ? i__7
                   : s_rnge("m2", i__7, "mxm_", (ftnlen)162)
                   ];
            if (i__1 == 0) {
              printf("PRODM[%d] <- %.16e\n", i__1, prodm[i__1]);
